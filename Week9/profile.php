...
// Ensure the same session path is used
...
// If user_id is missing, stop execution for debugging
if (!isset($_SESSION['user_id'])) {
    echo "Session is missing user_id! Stopping execution for debugging.";
    exit();
}
...
function saveShoppingCart($conn, $user_id, $shopping_cart)
{
    ...
    foreach ($shopping_cart as $item) {
        ...
        mysqli_query($conn, "INSERT INTO shopping_cart (user_id, product_id, product_name, product_quantity) VALUES ('$user_id', '$product_id', '$product_name', '$product_price', '$product_quantity')");
    }
}
                        ...
                        if (!empty($_SESSION["shopping_cart"])) {
                            ...
                            foreach ($_SESSION["shopping_cart"] as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="profile.php?action=delete&id=<?php echo $value['product_id']; ?>">
